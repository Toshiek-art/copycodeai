...
function createAccessLockedResponse() {
  ...
  <body>
    <main>
      <section class="card" aria-labelledby="access-title">
        ...
        <p>Request a new copy by email to access the checklist again.</p>
        <a href="${REQUEST_PATH}">Request a new access link</a>
      </section>
    </main>
  </body>
</html>`;
...
export async function onRequestGet(context) {
  ...
  return createAccessLockedResponse();
}
