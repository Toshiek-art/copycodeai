  ...
  const response = await fetch('https://api.brevo.com/v3/contacts', {
    ...
    body: JSON.stringify({
      ...
      attributes: {
        ...
        FLOW: payload.flow,
        ...(payload.source.leadSource ? { LEAD_SOURCE: payload.source.leadSource } : {}),
        ...(payload.content.resourceSlug ? { RESOURCE_SLUG: payload.content.resourceSlug } : {}),
        ...(payload.consent.newsletterOptIn !== undefined ? { NEWSLETTER_OPT_IN: payload.consent.newsletterOptIn } : {}),
        ...(payload.consent.resourceConsent !== undefined ? { RESOURCE_CONSENT: payload.consent.resourceConsent } : {}),
