...
// .wrangler/tmp/bundle-03kSYx/checked-fetch.js
...
// .wrangler/tmp/pages-HkOoBm/functionsWorker-0.9038965156173135.mjs
...
var send = /* @__PURE__ */ __name2((d, s = 200) => new Response(JSON.stringify(d), { status: s, headers: { "content-type": "application/json" } }), "send");
var onRequestGet = /* @__PURE__ */ __name2(async ({ env, params, request }) => {
  try {
    const DB = env?.DB;
...
var send2 = /* @__PURE__ */ __name2((data, status = 200) => new Response(JSON.stringify(data), { status, headers: { "content-type": "application/json" } }), "send");
...
var onRequestGet3 = /* @__PURE__ */ __name2(async () => {
...
var send3 = /* @__PURE__ */ __name2((data, status = 200) => new Response(JSON.stringify(data), {
  status,
...
var onRequest = /* @__PURE__ */ __name2(async ({ request }) => {
...
var onRequest3 = /* @__PURE__ */ __name2(async ({ env }) => {
  const team = (env.CF_ACCESS_TEAM_DOMAIN || "").replace(/\/$/, "");
...
var onRequest4 = /* @__PURE__ */ __name2(async ({ request, next }) => {
  const url = new URL(request.url);
...
// .wrangler/tmp/bundle-03kSYx/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-03kSYx/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.9038965156173135.js.map
